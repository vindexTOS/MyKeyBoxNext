...
const TeamDetailsContent = ({ teamInfo }) => {
  const { memberThumb, name, designation, email, memberData, skillProgress } =
    teamInfo;
            ...
            <div className="row">
              ...
              <div className="col-lg-7 right-info">
                ...
                <p>
                  ...
                  offshoring house in never fruit up. Pasture imagine my
                  garrets..
                </p>
                ...
                <div className="social">
                  <a className="btn circle btn-sm btn-dark animation" href="#">
                    Contact Me
                  </a>
