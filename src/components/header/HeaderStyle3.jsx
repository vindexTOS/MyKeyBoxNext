...
const HeaderStyle3 = () => {
  ...
  return (
    <>
      <header>
        <nav
          className={`navbar secondary mobile-sidenav navbar-sticky navbar-default validnavs navbar-fixed white on menu-center no-full ${
              ...
              <div className="attr-nav">
                <ul>
                  <li className="button light">
                    <Link href="/contact-us">Free Analysis</Link>
                  </li>
                </ul>
              </div>
            </div>
