...
const ProjectStyle1 = () => {
  return (
    <>
      <div
        style={{ width: "100%", height: 170, backgroundColor: "#212121" }}
        // className="project-style-one-area default-padding bg-dark bottom-shape-light"
      >
            ...
            <div className="row">
              <div className="col-lg-5">
                <div className="content-left">
                  <h3 className="sub-heading" style={{ top: 10 }}>
                    MYKEYBOX
                  </h3>
                  <h4 className="heading" style={{ bottom: 20 }}>
